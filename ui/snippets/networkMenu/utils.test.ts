...
describe('function getStaticNetworkPath()', () => {
  describe('static routes', () => {
    it('should return URL with pathname and search params for static route', () => {
      ...
      expect(result).toBe('https://example.com/blocks?page=1');
    });
    ...
    it('should handle URL with multiple trailing slashes for static route', () => {
      const url = 'https://example.com///';
      const router = mockRouter('/blocks', '/blocks?page=1');
  ...
  describe('dynamic routes', () => {
    ...
    it('should handle multiple dynamic segments', () => {
      const url = 'https://example.com';
      const router = mockRouter('/blocks/[hash]/[tab]', '/blocks/0x123/details?page=1');
    ...
    it('should handle catch-all dynamic routes', () => {
      const url = 'https://example.com';
      const router = mockRouter('/blocks/[...slug]', '/blocks/0x123/details?page=1');
    ...
    it('should handle optional catch-all dynamic routes', () => {
      const url = 'https://example.com';
      const router = mockRouter('/blocks/[[...slug]]', '/blocks?page=1');
  ...
  describe('edge cases', () => {
    ...
    it('should handle complex search params', () => {
      const url = 'https://example.com';
      const router = mockRouter('/blocks', '/blocks?page=1&filter=active&sort=date');

      const result = getStaticNetworkPath({ url, router });

      expect(result).toBe('https://example.com/blocks?page=1&filter=active&sort=date');
    });
    ...
    it('should handle URL with query parameters', () => {
      ...
      expect(result).toBe('https://example.com?existing=param/blocks?page=1');
    });

    it('should handle root pathname', () => {
      const url = 'https://example.com';
      const router = mockRouter('/', '/?page=1');
  ...
  describe('regex patterns', () => {
    ...
    it('should not treat static routes as dynamic', () => {
      const url = 'https://example.com';
      const router = mockRouter('/blocks/hash', '/blocks/hash?page=1');

      const result = getStaticNetworkPath({ url, router });

      expect(result).toBe('https://example.com/blocks/hash?page=1');
    });
  });
});
