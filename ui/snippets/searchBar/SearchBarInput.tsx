...
const SearchBarInput = (
  { onChange, onSubmit, isHeroBanner, isSuggestOpen, onFocus, onBlur, onHide, onClear, onFormClick, value, readOnly, placeholder, ...rest }: Props,
  ...
  const getPlaceholder = () => {
    return placeholder ?? (isMobile ? 'Search by query / ... ' : 'Search by query / address / entity key / txn hash / block... ');
  };
