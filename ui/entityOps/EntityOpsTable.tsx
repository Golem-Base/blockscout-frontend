    ...
    <AddressHighlightProvider>
      <TableRoot minW="950px">
        <TableHeaderSticky top={ top }>
          <TableRow>
            <TableColumnHeader w="100px">Type</TableColumnHeader>
            <TableColumnHeader w="200px">Entity Key</TableColumnHeader>
            <TableColumnHeader w="200px">Sender</TableColumnHeader>
            <TableColumnHeader w="200px">Transaction</TableColumnHeader>
          </TableRow>
        </TableHeaderSticky>
        <TableBody>
