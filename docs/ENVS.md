...
| NEXT_PUBLIC_NETWORK_RPC_URL | `string \| Array<string>` | Chain public RPC server url, see [https://chainlist.org](https://chainlist.org) for the reference. When multiple endpoints are provided, a switch will appear in the footer allowing the user to choose a prioritized RPC. | - | - | `https://core.poa.network` | v1.0.x+ |
