...
- `yarn test:pw:update <test-file> [args]` — update screenshots for all projects (desktop, mobile, dark mode) in Docker. 
  - Example: `yarn test:pw:update-all ui/snippets/searchBar/SearchBar.pw.tsx`
